...
class SacrParser():
    ...
    @staticmethod
    def get_ws_regex(additional_tokens=None):
    ...
    def parse(self):
        ...
        elif self.tokenization_mode == WHITESPACE_TOKENIZATION:
            word_pattern = self.__class__.get_ws_regex(additional_tokens)
