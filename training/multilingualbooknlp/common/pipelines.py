...
class Entity:
	def __init__(self, start, end, entity_id=None, quote_id=None, quote_eid=None, proper=None, ner_cat=None, in_quote=None, text=None):
		...
		# If the entity is in a quote, the *entity* outside the quote that is attributed to be the quote's speaker (used during training)
		self.quote_eid=quote_eid

		self.text=text

		# If the entity is in a quote, the *mention* outside the quote that is attributed to be the quote's speaker
