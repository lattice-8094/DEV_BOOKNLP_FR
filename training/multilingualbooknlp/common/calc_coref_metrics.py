...
def get_conll(path_to_scorer, gold=None, preds=None):
	...
	print("bcub_recall:\t%.1f" % bcub_r)
	print("muc_recall:\t%.1f" % muc_r)
	print("ceaf_recall:\t%.1f" % ceaf_r)
	avg_recall =(bcub_r + muc_r + ceaf_r)/3.
	print("Average recall: %.1f" % (avg_recall))

	print("bcub_recall:\t%.1f" % bcub_p)
	print("muc_recall:\t%.1f" % muc_p)
	print("ceaf_recall:\t%.1f" % ceaf_p)
	avg_p =(bcub_p + muc_p + ceaf_p)/3.
	print("Average precision: %.1f" % (avg_p))
