...
import os
from multilingualbooknlp.common.pipelines import Token
...
class GenderEM:
	...
	#what's the best way to do this? in french we only have son, sa, ses (doesn't distinguish by gender), am i doing by plural or by gender?
	#on a fait un liste de 'masculine, feminine, ambigue pour 'genders'
	def __init__(self, outfile=None, tokens=None, entities=None, entityFiles=None, tokenFiles=None, hyperparameterFile=None, distance=25, num_epochs=25, refs=None, upper=10, use_tagged_pronouns_only=True, genders=[["il", "ils", "eux"],["elle", "elles"],["leur", "leurs", "lui", "sa", "son", "ses"]] ):
	#def __init__(self, outfile=None, tokens=None, entities=None, entityFiles=None, tokenFiles=None, hyperparameterFile=None, distance=25, num_epochs=25, refs=None, upper=10, use_tagged_pronouns_only=True, genders=[["il", "lui", "sa", "son", "ses"],["elle", "lui", "sa", "son", "ses"],["ils", "elles", "leur", "leurs", "eux"]] ):
		...
		self.honorifics={"m.":1, "mme.":1, "mlle.":1, "dame":1, "sire":1, "capitaine":1, "m":1, "seigneur":1, "maître":1, "tante":1, "madame":1, "mme":1, "oncle":1, "colonel":1, "monsieur":1, "mademoiselle":1, "général":1, "commandante":1, "sergent":1, "mlle.":1,  "roi":1, "riene":1, "herr":1, "frau":1, "fräulein":1, "dame":1, "m":1, "maîtresse":1, "prince":1, "princesse":1, "lieutenant":1,
				   "duc":1, "duchesse":1, "marquis":1, "marquise":1, "comte":1, "comtesse":1, "vicomte":1,"vicomtesse":1, "baron":1, "baronne":1 }
...
if __name__ == "__main__":
	...
	genders=[["il", "ils", "lui", "sa", "son", "ses", "eux"],["elle", "elles", "lui", "sa", "son", "ses"],["leur", "leurs"]]
