from multilingualbooknlp.fr.tagger import Tagger
import torch
import re
import multilingualbooknlp.common.layered_reader as layered_reader
import multilingualbooknlp.common.sequence_layered_reader as sequence_layered_reader
...
class LitBankEntityTagger:
	def __init__(self, model_file, model_tagset):
		...
		self.model = Tagger(freeze_bert=False, base_model=base_model, tagset_flat={}, supersense_tagset={}, tagset=self.tagset, device=device)
